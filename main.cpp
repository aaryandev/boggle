...
//  boggle
//
//  Created by Aaryan Rawat on 18/11/21.
//
...
int main(){
    ...
    TrieNode *temp=NULL;
    ifstream dictionary;
    dictionary.open("/Users/aryan/Downloads/boggle/boggle/english3.txt");  // opening file containing all words,letters
    ...
    if(ans.size()==0){                                    // checking if no words are present
        ...
        cout<<"\nWords and abbreviations present are : ";    // printing all words and abbreviations
    ...
    cout<<"\n\n";
    cout<<"Project made by Aaryan Rawat 2K20/IT/02\n"<<endl;
    delete temp;
    return 0;
}
